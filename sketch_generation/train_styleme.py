...
def save_image(net_g, dataloader, saved_image_folder, n_iter):
    ...
    with torch.no_grad():
        ...
        del imgs
    net_g.train()  ## 启用 Batch Normalization 和 Dropout。
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_a', type=str, default='./wyt/RGB',
                        help='path of resource dataset, should be a folder that has one or many sub image folders inside')
    parser.add_argument('--path_b', type=str, default='./wyt/sketch',
    ...
    parser.add_argument('--trial_name', type=str, default="WYT", help='a brief description of the training trial')
    ...
    wandb.init(project="1.I2S_Gen", config=args, name="WYT")
