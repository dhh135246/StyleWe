...
if __name__ == "__main__":
    ...
    parser.add_argument('--trial_name', type=str, default="D3_ours", help='a brief description of the training trial')
    ...
    pathc = "./train_results/D3_ours/models/model_best.pth"
    ...
    wandb.init(project="FedGAI_st_baseline", config=args, name="D3_ours")
