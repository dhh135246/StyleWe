...
if __name__ == "__main__":
    ...
    parser.add_argument('--trial_name', type=str, default="D1_ours", help='a brief description of the training trial')
    ...
    pathc = "./train_results/D1_ours/models/model_best.pth"
    ...
    wandb.init(project="FedGAI_st_baseline", config=args, name="D1_ours")
